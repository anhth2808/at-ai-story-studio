...
## Purpose
Define durable production orchestration that aggregates bounded Shot quality work while preserving existing stage ownership, canonical media reuse, scoped invalidation, and honest release gates.
