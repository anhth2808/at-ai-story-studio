...
import { WorkerExecutor, createOmpAgent, createStoryEngine, SceneEngine } from '@studio/workflow';
const root =
...
const executor = new WorkerExecutor(context, workerId, undefined, storyEngine, sceneEngine);
let stopping = false;
